        ...
        switch ($name) {
            ...
            case 'vich_uploader.mappings': $value = array(
                ...
                'entrainement_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/../web/entrainement'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'sponsor_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/../web/sponsor'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'new_images' => array(
                    'uri_prefix' => '../web/new',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/../web/new'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'media_images' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/../web/media'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
