...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/gaelicBundle/Entity'), 1 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'gaelicBundle\\Entity');
...
$d->setEntityNamespaces(array('gaelicBundle' => 'gaelicBundle\\Entity', 'VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity'));
...
$instance = \Doctrine\ORM\EntityManager::create(${($_ = isset($this->services['doctrine.dbal.default_connection']) ? $this->services['doctrine.dbal.default_connection'] : $this->load('getDoctrine_Dbal_DefaultConnectionService.php')) && false ?: '_'}, $d);
