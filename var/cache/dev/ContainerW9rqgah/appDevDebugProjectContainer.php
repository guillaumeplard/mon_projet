...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Zl55ZET8zL', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DafYL0Ftit', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wWF5lJgngC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gfvAM0qXKq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GG-4M+Da9K', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('EasyCorp\\Bundle\\EasyAdminBundle\\Form\\Type\\EasyAdminAutocompleteType' => function () {
            ...
            return ${($_ = isset($this->services['fos_user.change_password.form.type']) ? $this->services['fos_user.change_password.form.type'] : $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('gaelicBundle\\Entity\\User')) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => function () {
            return ${($_ = isset($this->services['fos_user.profile.form.type']) ? $this->services['fos_user.profile.form.type'] : $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('gaelicBundle\\Entity\\User')) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => function () {
            return ${($_ = isset($this->services['fos_user.registration.form.type']) ? $this->services['fos_user.registration.form.type'] : $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('gaelicBundle\\Entity\\User')) && false ?: '_'};
        }, 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => function () {
            return ${($_ = isset($this->services['fos_user.resetting.form.type']) ? $this->services['fos_user.resetting.form.type'] : $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('gaelicBundle\\Entity\\User')) && false ?: '_'};
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('26fec43fa84c93ef127b9d5b8378a80113576d1d')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/gaelicBundle/Resources/views'), 'gaelic');
        $instance->addPath(($this->targetDirs[3].'/src/gaelicBundle/Resources/views'), '!gaelic');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('26fec43fa84c93ef127b9d5b8378a80113576d1d');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'gaelicBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/gaelicBundle'),
                    'namespace' => 'gaelicBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
            ...
            case 'vich_uploader.mappings': $value = array(
                'product_images' => array(
                    'uri_prefix' => '../web/uploads/images/products',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web../web/uploads/images/products'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'entrainement_images' => array(
                    'uri_prefix' => '../web/entrainement',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/entrainement../web/entrainement'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'sponsor_images' => array(
                    'uri_prefix' => '../web/sponsor',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/sponsor'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'new_images' => array(
                    'uri_prefix' => '../web/new',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/new'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
                ...
                'media_images' => array(
                    'uri_prefix' => '../web/media',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/media'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'gaelicBundle' => 'gaelicBundle\\gaelicBundle',
            ...
            'database_port' => 8889,
            'database_name' => 'gaelic_football',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'smtp',
            'mailer_host' => 465,
            'mailer_user' => 'smtp.gmail.com',
            'mailer_password' => 'votreemail@gmail.com',
            'secret' => '26fec43fa84c93ef127b9d5b8378a80113576d1d',
            ...
            'kernel.secret' => '26fec43fa84c93ef127b9d5b8378a80113576d1d',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 465,
            'swiftmailer.mailer.default.transport.smtp.username' => 'smtp.gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'votreemail@gmail.com',
            ...
            'fos_user.model.user.class' => 'gaelicBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'guillaume.plard@lapiscine.pro' => 'guillaume',
            ),
            ...
            'easyadmin.config' => array(
                'site_name' => '<a href="{{ path(gaelic_homepage)}}">Burdigaela</a>',
                'design' => array(
                    'brand_color' => '#770808',
                    'theme' => 'default',
                    'color_scheme' => 'dark',
                    ...
                    'News' => array(
                        ...
                        'form' => array(
                            'fields' => array(
                                0 => array(
                                    'type' => 'tab',
                                    'label' => 'enregistrement actualité',
                                    'icon' => 'newspaper-o',
                                ),
                                1 => 'titre',
                                2 => 'Contenu',
                        ...
                        'list' => array(
                            'fields' => array(
                                0 => array(
                                    'property' => 'image',
                                    'type' => 'image',
                                    'base_path' => '../web/uploads/images/products',
                                ),
                            ),
                        ),
                        'show' => array(
